...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2022 at 01:18 PM
...
(4, '[32,2,4,12]', '[\"Supplier\",\"Supplier\",\"Supplier\",\"Supplier\"]', '[\"7.5\",\"5\",\"2.5\",\"5\"]', '[\"7.5\",\"5\",\"2.5\",\"5\"]', 2);
...
(3, '2021-09-23', 'Kokum Butter', 'Kokum Butter', 'Moisturiser', '721', 0, '22.95', '9', 0, '1657274461_937c6952eabf9e272ed1.pdf'),
...
(1, 2, '1', 20, 'Supplier', 20, 5, '200x100mm', 20, 'Supplier', 20, 5, '1 pack', 20, 'Supplier', 20, 5, '1 bag', 20, 'Supplier', 20, 5, '1 note', 20, 'Supplier', 20, 5, 'Carbon Neutral Delivery', 20, 'Supplier', 20, 5);
...
(3, '2022-09-01', 'Test Item', 'Tall Boston', 212, 25, '5', '5', '18', 'Nathan', '1662018389_121b03c59f5f91a9210d.pdf', '', '');
...
--
ALTER TABLE `tbl_stockcheck_delivery_items`
  MODIFY `delivery_items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
