...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2022 at 07:33 PM
...
INSERT INTO `tbl_ingredients` (`ingredient_id`, `ingredient_date`, `ingredient_name`, `ingredient_inci`, `ingredient_category`, `ingredient_qty`, `ingredient_vat`, `ingredient_price`, `ingredient_supplier`, `invoice_file`) VALUES
(1, '2021-09-22', 'Distilled Water', 'Agua', 'Base', '2', 0, '11.81', '4', ''),
(2, '2021-09-25', 'Peppermint Essential Oil', 'Mentha Piperita', 'Essential Oil', '2', 0, '7.29', '13', ''),
(3, '2021-09-25', 'Tea Tree Essential Oil', 'Melaleuca Alternifolia', 'Essential Oil', '3', 0, '17.99', '13', ''),
(4, '2021-09-25', 'Ylang Ylang Essential Oil', 'Cananga Odorata', 'Essential Oil', '4', 0, '9.89', '13', ''),
(5, '2021-09-25', 'Ginger Essential Oil', 'Zingiber Officinalis', 'Essential Oil', '5', 0, '24.09', '13', ''),
(6, '0000-00-00', 'Lavender Essential Oil', 'Lavandula Angustifolia', 'Essential Oil', '2', 0, '16.99', '13', ''),
(7, '2021-09-25', 'Cedarwood Essential Oil', 'Cedarus Atlantica', 'Essential Oil', '5', 0, '13.49', '13', '');
...
INSERT INTO `tbl_stockcheck_delivery` (`delivery_id`, `delivery_date`, `delivery_supplier`, `delivery_logger`, `delivery_price`, `delivery_vat`, `delivery_fee`, `invoice_file`) VALUES
...
--
ALTER TABLE `tbl_expenses`
  MODIFY `expenses_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `tbl_stockcheck_delivery_items`
  MODIFY `delivery_items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `tbl_sub_policies`
--
ALTER TABLE `tbl_sub_policies`
  MODIFY `p_sub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tbl_sub_processes`
--
ALTER TABLE `tbl_sub_processes`
  MODIFY `pr_sub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
