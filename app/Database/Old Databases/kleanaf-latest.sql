...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2022 at 03:46 PM
...
(1, '2022-05-28', 'Stove', 'Stove ', '7', '25', 0, 0, '6', ''),
(2, '2022-06-11', 'Spatula', 'Large', '1', '5', 0, 1, '16', '1654940443_27ac32bddd2c3b2b6bc8.pdf');
...
CREATE TABLE `tbl_expenses` (
  ...
  `expenses_delivery` int(11) NOT NULL,
...
INSERT INTO `tbl_expenses` (`expenses_id`, `expenses_date`, `expenses_category`, `expenses_description`, `expenses_price`, `expenses_vat`, `expenses_delivery`, `expenses_supplier`, `expenses_staff`, `expenses_status`) VALUES
(1, '2021-09-22', 'Ingredients', 'Agua', '11.81', 0, 0, '4', '', ''),
(2, '2021-09-25', 'Ingredients', 'Mentha Piperita', '7.29', 0, 0, '13', '', ''),
(3, '2021-09-25', 'Ingredients', 'Melaleuca Alternifolia', '17.99', 0, 0, '13', '', ''),
(4, '2021-09-25', 'Ingredients', 'Cananga Odorata', '9.89', 0, 0, '13', '', ''),
(5, '2021-09-25', 'Ingredients', 'Zingiber Officinalis', '24.09', 0, 0, '13', '', ''),
(6, '0000-00-00', 'Ingredients', 'Lavandula Angustifolia', '16.99', 0, 0, '13', '', ''),
(7, '2021-09-25', 'Ingredients', 'Cedarus Atlantica', '13.49', 0, 0, '13', '', ''),
(8, '2022-05-28', 'Media', 'Labelling', '250', 0, 0, 'User Name', '', ''),
(9, '2022-05-28', 'Media', 'Advertising', '1', 0, 0, '8', '', ''),
(10, '2022-05-28', 'Equipment', 'Stove', '25', 0, 0, '6', '', ''),
(12, '2022-05-29', 'Media', 'Advertising', '100', 0, 0, '9', '', ''),
(13, '2022-05-29', 'Media', 'Advertising', '100', 0, 0, '9', '', ''),
(14, '2022-05-29', 'Media', 'Advertising', 'N/A', 0, 0, '9', '', ''),
(15, '2022-05-29', 'Bank Charges', 'Travel', '100', 0, 0, '20', '9', 'New'),
(16, '2022-06-02', 'Ingredient', 'Cedarus Atlantica', '300', 0, 0, '8', '', ''),
(17, '2022-06-02', 'Equipment', 'Stove', '599', 0, 0, '8', '', ''),
(18, '2022-06-02', 'Ingredient', 'Cedarus Atlantica', '352', 0, 0, '4', '', ''),
(19, '2022-06-02', 'Ingredient', 'Cedarus Atlantica', '750', 0, 0, '4', '', ''),
(20, '2022-06-02', 'Ingredient', 'Cedarus Atlantica', '50', 0, 0, '4', '', ''),
(21, '2022-06-02', 'Ingredient', '1', '1', 0, 0, '8', '', ''),
(22, '2022-06-02', 'Media', 'Advertising', '11', 0, 0, '12', '', ''),
(23, '2022-06-02', 'Media', 'Advertising', '111', 0, 0, '12', '', ''),
(24, '2022-06-02', 'Ingredients', 'tt', '100', 0, 0, '1', '', ''),
(25, '2022-06-10', 'Equipment', 'ttt', 'tt', 0, 0, '1', '', ''),
(26, '2022-06-03', 'Ingredient', '1', '11', 0, 0, '8', '', ''),
(27, '2022-06-03', 'Equipment', '1', '11', 0, 0, '8', '', ''),
(28, '2022-06-03', 'Ingredient', '1', '100', 0, 0, '8', '', ''),
(29, '2022-06-03', 'Equipment', '1', '190', 0, 0, '8', '', ''),
(30, '2022-06-04', 'Accountacy Fee', 'test', '100', 0, 0, '3', '12', 'New'),
(31, '2022-06-06', 'Media', 'Advertising', '10', 0, 0, '12', '', ''),
(32, '2022-06-06', 'Ingredient', '1', '100', 0, 0, '4', '', ''),
(33, '2022-06-06', 'Ingredient', '1', '20', 0, 0, '5', '', ''),
(34, '2022-06-07', 'Ingredients', 'Test', '100', 0, 0, '17', '', ''),
(35, '2022-06-11', 'Ingredient', '1', '10', 0, 0, '3', '', ''),
(36, '2022-06-11', 'Equipment', '1', '100', 0, 0, '3', '', ''),
(37, '2022-06-11', 'Equipment', 'Spatula', '5', 0, 0, '16', '', '');
...
(1, '2021-09-22', 'Distilled Water', 'Agua', 'Base', '21', 0, '11.81', '4', 0, ''),
...
(8, '2022-06-07', 'Test', 'Test', 'Oil', '91', 300, '100', '17', 100, '1654543773_eb750dac4227d90e8be4.png');
...
CREATE TABLE `tbl_stockcheck_items` (
  `stockcheck_items` int(11) NOT NULL,
  `stockcheck_id` int(11) NOT NULL,
...
(1, 1, 'Expenses Procedure', '2022-06-11', '1654943984_fa50ab80f588bb3b0baa.pdf', '0000-00-00 00:00:00');
...
--
ALTER TABLE `tbl_expenses`
  MODIFY `expenses_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `tbl_stockcheck`
  MODIFY `stockcheck_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_stockcheck_delivery_items`
  MODIFY `delivery_items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `tbl_sub_policies`
--
ALTER TABLE `tbl_sub_policies`
  MODIFY `p_sub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
