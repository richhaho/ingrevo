	...
	<body>
		<div class="container" id="container">
			<div class="form-container log-in-container">
				<form id="retrive_p" action="<?= base_url() ?>/ppress" method="post">
					<img src="<?= base_url() ?>/public/files/logos/1.svg" width="50%" class="img-fluid text-center mb-10" alt="Logo">
					<h1>RETRIEVE PASSWORD</h1></br>
					<input class="mb-25" name="user_email" placeholder="Email"/>
					
					<?php if(session()->getFlashdata('msg')):?>
						<div class="alert text-muted flash_msg mb-25" style="color: green !important;"><?= session()->getFlashdata('msg') ?></div> 
					<?php endif;?>
					<div class="flash_msg hide" id="flash_msg" style="color: green !important;"></div> 

					<div class="d-flex">
						<button type="submit">
							RESET
						</button>
						<span class="hide spinner-loader spinner "> Loading</span>
					</div>
					...
					<div class="row"> 
						...
						<a href="https://instagram/ingrevo"><i class="fa-brands fa-instagram fa-xl"></i></a>
					</div>
...
<script>
	$("button[type='submit']").click(function(e) {
		...
		$('.spinner').removeClass('hide').addClass('spinner-loader');
		$('#retrive_p').submit();
	});
</script>
<style>
