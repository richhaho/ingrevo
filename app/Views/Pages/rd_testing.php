  ...
  <main role="main" class="col-md-12 ml-sm-auto col-lg-12 pt-3 px-3">
    ...
    <div class="row mb-3 pb-3 text-center">
      <div class="col">
        <button type="button" class="btn btn-sm btn-success text-center" data-bs-toggle="modal"
          data-bs-target="#entryModal">Upload Testing</button>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Upload PIF</h5>
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-8">
                  <select class="form-select" id="cpn_formula" name="cpn_formula" required>
                    <option value="" selected>Choose Formula</option>
                    <?php foreach ($formula as $data) { ?>
                      <option value="<?php echo $data->formula_id ?>"><?php echo $data->formula_version ?>
                        <?php echo $data->formula_rdplan ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Testing</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
